<?php if(!class_exists('Rain\Tpl')){exit;}?><form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="degloriocg@gmail.com">  
        ...
        <input type="hidden" name="itemShippingCost1" value="<?php echo htmlspecialchars( $order["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
